...
$up_wlimit_upper = 2160;//横幅
$up_hlimit_upper = 2160;//縦幅


//アップロードできる最小の縦横サイズ（ピクセル）
$up_wlimit_lower = 200;//横幅
$up_hlimit_lower = 200;//縦幅
...
//サムネイル画像の保存サイズ
$save_wmax_s = 150;//横幅最大
$save_hmax_s = 113;//縦幅最大

//PCTOP一覧用サムネイル画像の保存サイズ
$pct_save_wmax_s = 400;//横幅最大
$pct_save_hmax_s = 400;//縦幅最大
//PC一覧用サムネイル画像の保存サイズ
$pcl_save_wmax_s = 210;//横幅最大
$pcl_save_hmax_s = 210;//縦幅最大
//PC表示画像の保存サイズ
$pc_save_wmax_s = 150;//横幅最大
$pc_save_hmax_s = 150;//縦幅最大

//スマホTOP一覧用サムネイル画像の保存サイズ
$smt_save_wmax_s = 80;//横幅最大
$smt_save_hmax_s = 80;//縦幅最大
//スマホ一覧用サムネイル画像の保存サイズ
$sml_save_wmax_s = 80;//横幅最大
$sml_save_hmax_s = 80;//縦幅最大
//スマホ用画像の保存サイズ
$sm_save_wmax_s = 300;//横幅最大
$sm_save_hmax_s = 225;//縦幅最大
